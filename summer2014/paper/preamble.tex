...
\newcommand{\alvincomment}[1]{   \colorbox{violet}{\makebox[2em]{\strut\textcolor{yellow}{ACG}}} {   \colorbox{violet}{\textcolor{yellow}{\parbox{.8\linewidth}{\scriptsize Alvin: #1}  }}}}
\newcommand{\jbgcomment}[1]{  \colorbox{red}{   \parbox{.8\linewidth}{ JBG: #1}  }}
\newcommand{\yhcomment}[1]{  \colorbox{green}{  \parbox{.8\linewidth}{ YH:  #1}
  }}
\newcommand{\hhecomment}[1]{  \colorbox{green}{  \parbox{.8\linewidth}{ HH:  #1}
  }}
...
\else
\newcommand{\nahocomment}[1]{ }
\newcommand{\alvincomment}[1]{\textcolor{yellow}{[#1] }}
